  ...
  return (
    <div className="w-full max-w-md mx-auto bg-[#111118]/80 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl relative">
      ...
      <div className="p-6 border-b border-white/5 bg-white/[0.02]">
        ...
        <p className="text-sm text-slate-400 mt-1">Please enter your details to receive your digital safety pass.</p>
      </div>
      ...
      <form action={handleSubmit} className="p-6 space-y-5 relative z-10">
        ...
        <Button disabled={loading} type="submit" className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold h-14 rounded-xl shadow-[0_0_20px_rgba(37,99,235,0.4)] text-lg mt-2">
          {loading ? "Registering pass..." : <><CheckCircle2 className="w-5 h-5 mr-2" /> Complete Check-In</>}
        </Button>
      </form>
    </div>
  );
